...
public class CompilationPublicServiceTest {
    ...
    void shouldReturnAllCompilationsWhenPinnedNull() {
        ...
        List<CompilationDto> result = service.getPublicCompilations(null, 0, 10);
    ...
    void shouldReturnPinnedCompilations() {
        ...
        List<CompilationDto> result = service.getPublicCompilations(true, 0, 10);
    ...
    void shouldGetCompilationById() {
        ...
        CompilationDto result = service.getPublicCompilationById(1L);
    ...
    void shouldThrowExceptionWhenCompilationNotFound() {
        ...
        assertThrows(CompilationNotFound.class, () -> service.getPublicCompilationById(1L));
    }
