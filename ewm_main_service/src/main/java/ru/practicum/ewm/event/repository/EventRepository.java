...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    @Query("""
            ...
            """)
    Page<Event> getEventsByFilters(@Param("text") String text, @Param("categories") List<Integer> categories,
    ...
    @Query("""
            ...
            """)
    Page<Event> getEventsByAdminFilters(@Param("users") List<Long> users, @Param("states") List<EventState> states,
